...
# 2. Install pygraphviz (requires build-essential and graphviz-dev in WSL)
# First install system dependencies: sudo apt update && sudo apt install -y build-essential graphviz graphviz-dev pkg-config
